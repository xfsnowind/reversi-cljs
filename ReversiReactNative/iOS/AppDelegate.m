...
{
  [context evaluateScript:[NSString stringWithFormat:@"goog.require('%@');", [self munge:@"reversi-cljs.core"]]];
}
...
- (void)contentDidAppear
{
  ...
  JSValue* initFn = [self getValue:@"init" inNamespace:@"reversi-cljs.core" fromContext:context];
